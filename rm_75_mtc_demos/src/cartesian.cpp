...
Task createTask(const rclcpp::Node::SharedPtr& node) {
  ...
  const std::string arm = "rm_75_arm";
//   const std::string arm_with_gripper = "arm_with_gripper";
  ...
  // Set the initial state of the robot
  {
    ...
    state.setToDefaultValues(state.getJointModelGroup("rm_75_arm"), "pose1");
  ...
  // Stage 1: Move 0.05 meters in the positive x direction relative to the world frame
  {
    ...
    // Set the frame of reference for this movement (the "world" frame)
  ...
  // Stage 2: Move 0.02 meters in the negative y direction relative to the world frame
//   {
...
//   }
  ...
  // Stage 3: Rotate 18 degrees around the z-axis of the world frame
//   {
...
//       { "joint1", M_PI / 12. },  // Rotate this joint by 15 degrees (pi/12 radians)
//       { "joint2", -M_PI / 12. }   // Rotate this joint by -15 degrees
//     };
